...
public class ImageTransformerUtil {
    ...
    private static String obtenerCodigoAnsi(int value) {
        ...
        if (value>=0 && value<=255){
            ...
            color = "ERROR: el valor debe estar entre 0 y 255";
        }
        return color;
    }
    ...
    public static int[][] rotarDerecha(int[][] matriz) {
        ...
        for (int i=0; i<matriz.length; i++){
            for (int j=0; j<matriz[0].length; j++){
                matrizaux[j][matriz.length-1-i] = matriz[i][j] ;
            }
        }
        return matrizaux;
    }
    ...
    public static int[][] rotarIzquierda(int[][] matriz) {
        ...
        for (int i=0; i<matriz.length; i++){
            for (int j=0; j<matriz[0].length; j++){
                matrizaux[matriz.length-1-j][i] = matriz[i][j] ;
            }
        }
        return matrizaux;
    }
    ...
    public static int[][] espejoHorizontal(int[][] matriz) {
        ...
        for (int i=0; i<matriz.length; i++){
            for (int j=0; j<matriz[0].length; j++){
                matrizaux [i][matriz.length-1-j] = matriz[i][j] ;
            }
        }
        return matrizaux;
    }
    ...
    public static int[][] espejoVertical(int[][] matriz) {
        ...
        for (int i=0; i<matriz.length; i++){
            for (int j=0; j<matriz[0].length; j++){
                matrizaux [matriz.length-1-i][j] = matriz[i][j] ;
            }
        }
        return matrizaux;
    }
